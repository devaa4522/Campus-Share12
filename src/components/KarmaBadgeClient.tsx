...
export default function KarmaBadgeClient({ initialKarma, userId }: { initialKarma: number; userId: string }) {
  ...
  return (
    <span className="hidden sm:inline-flex items-center gap-1.5 text-xs font-bold px-3 py-1.5 bg-secondary/10 text-secondary rounded-full transition-all duration-300">
