export default function Loading() {
  return (
    <div className="flex flex-col pt-24 pb-20 px-4 md:px-8 max-w-4xl mx-auto w-full min-h-full">
      <section className="w-full bg-primary rounded-3xl p-6 md:p-8 shadow-[0px_12px_32px_rgba(0,10,30,0.06)] relative overflow-hidden border border-primary/10">
        <div className="relative z-10">
          <div className="flex justify-between items-center mb-8">
            <h3 className="font-headline text-2xl font-bold text-white tracking-tight">Dashboard Overview</h3>
            <span className="px-3 py-1 bg-secondary/20 text-secondary rounded-full text-xs font-label font-bold tracking-wide">LOADING</span>
          </div>
