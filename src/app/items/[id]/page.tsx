      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-5 space-y-6">
          <section>
            ...
            <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight text-primary mb-4 font-headline leading-tight">
              {typedItem.title}
            </h1>
            ...
            <div className="flex flex-wrap gap-3">
              {typedItem.condition && (
                <span className="px-4 py-2 rounded-lg bg-surface-container-low text-primary text-sm font-semibold flex items-center gap-2 border border-outline-variant/10">
          ...
          {profile && (
            <div className="bg-surface-container-lowest rounded-xl p-6 shadow-[0_8px_24px_rgba(0,10,30,0.04)] border border-outline-variant/20">
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                 <div className="bg-secondary/10 border border-secondary/20 p-3 rounded-lg flex flex-col items-center justify-center text-center">
                    <p className="text-[10px] font-bold text-secondary uppercase tracking-widest mb-1">Trust Score</p>
                    <div className="flex items-baseline gap-1">
                       <span className="text-2xl font-black text-secondary">{trustScore}%</span>
                    </div>
                 </div>
                 <div className="bg-primary/5 border border-primary/10 p-3 rounded-lg flex flex-col items-center justify-center text-center">
                    <p className="text-[10px] font-bold text-primary uppercase tracking-widest mb-1">Trade Count</p>
                    <div className="flex items-baseline gap-1">
                       <span className="text-2xl font-black text-primary">{tradeCount}</span>
                       <span className="text-[10px] font-bold text-primary/60 uppercase">Trades</span>
                    </div>
                 </div>
              </div>
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-4 py-3 border-t border-outline-variant/10 mt-4 pt-4">
              ...
              <div>
                <h4 className="text-xs font-bold text-primary">Academic Integrity Protection</h4>
